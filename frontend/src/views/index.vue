  ...
  <div class="main" @contextmenu.prevent="contextmenu($event)">
    ...
    <div class="menu">
      ...
      <!-- <cTooltip :placement="'top'">
        ...
        <template v-slot:tip>
          <p class="info">* 加载游戏存档</p>
        </template>
      </cTooltip> -->

      <cTooltip :placement="'top'">
        <template v-slot:content>
          <div class="Backpack" @click="importSaveData">
...
export default {
  ...
  methods: {
    ...
    //  const el=  await this.drizzleInstance.contracts["FindoraGame"]
    //   .methods["getGameDate"].cacheCall();
      // this.loadGame(el)
    ...
    saveGame(needInfo) {
      ...
      this.drizzleInstance.contracts["FindoraGame"]
      .methods["setGameData"]
      .cacheSend(saveData);
